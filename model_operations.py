...
MARKET_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "tb": {"tracker_market": "batter_total_bases", "target": "tb_over_1.5", "line": 1.5},
    "tb_2.5": {"tracker_market": "batter_total_bases", "target": "tb_over_2.5", "line": 2.5},
    "tb_3.5": {"tracker_market": "batter_total_bases", "target": "tb_over_3.5", "line": 3.5},
    "hr": {"tracker_market": "batter_home_runs", "target": "hr_over_0.5", "line": 0.5},
    "rbi": {"tracker_market": "batter_rbis", "target": "rbi_over_0.5", "line": 0.5},
    "rbi_1.5": {"tracker_market": "batter_rbis", "target": "rbi_over_1.5", "line": 1.5},
